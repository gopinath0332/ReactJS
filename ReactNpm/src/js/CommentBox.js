...
var blobData = [{ name: "Jhonny", "comment": "Comment from Jhonny" },
    { name: "Jhonny1", "comment": "Comment from Jhonny1" },
    { name: "Jhonny2", "comment": "Comment from Jhonny2" }
];
...
var CommentBox = React.createClass({
    ...
    handleCommentSubmit: function(comment) {
        ...
        currentData.splice(0, 0, { name: comment.name, about: comment.comment });
...
var CommentList = React.createClass({
    render: function() {
        var nodes = this.props.data.map((item, index) => {
            return (<Comment author={item.name} key={index+1}>{item.about}</Comment>);
        });
...
var CommentForm = React.createClass({
    ...
    render: function() {
        return (<div className="commentForm">
        	<input type="text"  onChange={this.handleNameChange} placeholder="Username..."/><br/><br/>
        	<input type="text"  onChange={this.handleCommentChange} placeholder="Comment..."/><br/><br/>
...
ReactDom.render(<CommentBox url="./js/profile.json"></CommentBox>, targetNode);
